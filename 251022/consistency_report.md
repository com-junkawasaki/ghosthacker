...
- Arcs: `Loneliness-Archipelago` はE1のみ、`NeiChanDebt` はS3E1→S3E2へ継続、`Nero666` はS4E1→S4E2→S6E1、`YHWH_IAM` はS5E1→S6E1。交差に矛盾なし。
...
2. Arc continuity
   - OK: `NeiChanDebt` がS3E1/E2へ連続し、S4以降に持ち越し無し。
...
5. Thematic causality
   - OK: E1の非分離体験がS2E1の輪廻観へと態度の基盤を提供。
   - OK: S2E1の「次の宇宙」視点がS3の負債管理プロトコルへ発展。
