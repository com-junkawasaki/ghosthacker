...
## gh:Episode/S6E1
- target vs actual (last segment):
  - fear: target=0.00 actual=0.50 delta=0.50
  - anger: target=0.00 actual=0.50 delta=0.50
  - trust: target=0.35 actual=0.00 delta=-0.35
  - hope: target=0.25 actual=0.00 delta=-0.25
  - joy: target=0.00 actual=0.00 delta=0.00
  - sadness: target=0.00 actual=0.00 delta=0.00
...
- target vs actual (last segment):
  ...
  - anticipation: target=0.00 actual=0.25 delta=0.25
  - hope: target=0.00 actual=0.25 delta=0.25
  - joy: target=0.20 actual=0.00 delta=-0.20
  - relief: target=0.35 actual=0.25 delta=-0.10
  - sadness: target=0.00 actual=0.00 delta=0.00
- 提案: 終盤に『赦し』『水』『静けさ』のモチーフを追加。短いQuiet Winの会話と呼吸描写で余韻を延ばす。
...
## gh:Episode/EP11
- target vs actual (last segment):
  - hope: target=0.00 actual=0.51 delta=0.51
  - relief: target=0.35 actual=0.14 delta=-0.21
  - fear: target=0.00 actual=0.21 delta=0.21
  - joy: target=0.20 actual=0.00 delta=-0.20
...
## gh:Episode/EP12
- target vs actual (last segment):
  - fear: target=0.00 actual=0.33 delta=0.33
  - hope: target=0.28 actual=0.51 delta=0.23
  - trust: target=0.38 actual=0.15 delta=-0.23
  - joy: target=0.00 actual=0.00 delta=0.00
  - sadness: target=0.00 actual=0.00 delta=0.00
  - anger: target=0.00 actual=0.00 delta=0.00
- 提案: 不安描写は名づけ→整えで早めに解く。"待つ契約"や"I AM"の台詞で恐れを関係に変換。