...
test.describe('Story Node Interaction', () => {
  ...
  test('Chatting with a character node', async ({ Given, When, Then, And, page }) => { 
    ...
    await When('I click on a character node named "Tamaki"', null, { page }); 
