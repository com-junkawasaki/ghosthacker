...
test.describe('Storyboard File Persistence', () => {
  ...
  test('Saving a storyboard and verifying it persists', async ({ Given, When, Then, And, page }) => { 
    ...
    await And('I wait for the "Syncing story world" message to disappear', null, { page }); 
