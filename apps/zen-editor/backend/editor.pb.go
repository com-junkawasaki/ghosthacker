...
type Node struct {
	...
	Content       string                 `protobuf:"bytes,6,opt,name=content,proto3" json:"content,omitempty"` // For blocks, the actual text
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Edge struct {
	...
	Color         string                 `protobuf:"bytes,4,opt,name=color,proto3" json:"color,omitempty"` // Optional: specify color for different relations
	Style         string                 `protobuf:"bytes,5,opt,name=style,proto3" json:"style,omitempty"` // Optional: "solid", "dashed", "dotted"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_editor_proto_rawDesc = "" +
	...
	"\x05style\x18\x05 \x01(\tR\x05style2\xed\x03\n" +
	"\rEditorService\x12t\n" +
