...
const (
	...
	// EditorServiceSaveNodeProcedure is the fully-qualified name of the EditorService's SaveNode RPC.
	EditorServiceSaveNodeProcedure = "/gftd.ghosthacker.zeneditor.v1.EditorService/SaveNode"
...
var (
	...
	editorServiceSaveNodeMethodDescriptor           = editorServiceServiceDescriptor.Methods().ByName("SaveNode")
	editorServiceOpenFileMethodDescriptor           = editorServiceServiceDescriptor.Methods().ByName("OpenFile")
	editorServiceSaveFileMethodDescriptor           = editorServiceServiceDescriptor.Methods().ByName("SaveFile")
)
...
type EditorServiceClient interface {
	...
	SaveNode(context.Context, *connect.Request[proto.SaveNodeRequest]) (*connect.Response[proto.SaveNodeResponse], error)
...
func NewEditorServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EditorServiceClient {
	...
	return &editorServiceClient{
		...
		saveNode: connect.NewClient[proto.SaveNodeRequest, proto.SaveNodeResponse](
			httpClient,
			baseURL+EditorServiceSaveNodeProcedure,
			connect.WithSchema(editorServiceSaveNodeMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		openFile: connect.NewClient[proto.OpenFileRequest, proto.OpenFileResponse](
			httpClient,
			baseURL+EditorServiceOpenFileProcedure,
			connect.WithSchema(editorServiceOpenFileMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		saveFile: connect.NewClient[proto.SaveFileRequest, proto.SaveFileResponse](
			httpClient,
			baseURL+EditorServiceSaveFileProcedure,
			connect.WithSchema(editorServiceSaveFileMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type editorServiceClient struct {
	...
	saveNode           *connect.Client[proto.SaveNodeRequest, proto.SaveNodeResponse]
...
// SaveNode calls gftd.ghosthacker.zeneditor.v1.EditorService.SaveNode.
func (c *editorServiceClient) SaveNode(ctx context.Context, req *connect.Request[proto.SaveNodeRequest]) (*connect.Response[proto.SaveNodeResponse], error) {
	return c.saveNode.CallUnary(ctx, req)
}
...
func NewEditorServiceHandler(svc EditorServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	editorServiceSaveNodeHandler := connect.NewUnaryHandler(
		EditorServiceSaveNodeProcedure,
		svc.SaveNode,
		connect.WithSchema(editorServiceSaveNodeMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/gftd.ghosthacker.zeneditor.v1.EditorService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case EditorServiceSaveNodeProcedure:
			editorServiceSaveNodeHandler.ServeHTTP(w, r)
...
func (UnimplementedEditorServiceHandler) SaveNode(context.Context, *connect.Request[proto.SaveNodeRequest]) (*connect.Response[proto.SaveNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gftd.ghosthacker.zeneditor.v1.EditorService.SaveNode is not implemented"))
}
