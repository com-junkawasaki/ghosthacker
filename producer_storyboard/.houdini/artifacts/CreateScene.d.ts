export type CreateScene = {
    readonly "input": CreateScene$input;
    readonly "result": CreateScene$result;
};

export type CreateScene$result = {
...
export type CreateScene$input = {
    input: CreateSceneInput;
};

export type CreateScene$optimistic = {
    readonly createScene?: {
        readonly id?: string;
        readonly storyboardId?: string;
        readonly sceneNumber?: number;
...
export type CreateScene$artifact = {
    "name": "CreateScene";
