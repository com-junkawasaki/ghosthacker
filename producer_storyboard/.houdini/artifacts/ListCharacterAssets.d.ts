export type ListCharacterAssets = {
    readonly "input": ListCharacterAssets$input;
    readonly "result": ListCharacterAssets$result | undefined;
};

export type ListCharacterAssets$result = {
...
export type ListCharacterAssets$input = {
    characterId: string | number;
};

export type ListCharacterAssets$artifact = {
