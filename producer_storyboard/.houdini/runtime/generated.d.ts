...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListScenariosStore, ListScenarios$result, ListScenarios$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [GetSceneStore, GetScene$result, GetScene$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [GetScenarioStore, GetScenario$result, GetScenario$input], [GetComposerStore, GetComposer$result, GetComposer$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input]];
};