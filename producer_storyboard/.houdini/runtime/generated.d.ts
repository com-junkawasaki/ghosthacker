...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListScenesStore, ListScenes$result, ListScenes$input], [GetSceneStore, GetScene$result, GetScene$input], [ListProjectsStore, ListProjects$result, ListProjects$input]];
};