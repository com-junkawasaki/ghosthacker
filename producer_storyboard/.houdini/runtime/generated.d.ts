...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListProjectsStore, ListProjects$result, ListProjects$input], [ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetComposerStore, GetComposer$result, GetComposer$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetSceneStore, GetScene$result, GetScene$input]];
};