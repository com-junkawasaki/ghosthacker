...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListScenariosStore, ListScenarios$result, ListScenarios$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetSceneStore, GetScene$result, GetScene$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetScenarioStore, GetScenario$result, GetScenario$input], [GetComposerStore, GetComposer$result, GetComposer$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input]];
};