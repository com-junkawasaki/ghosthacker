...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListScenariosStore, ListScenarios$result, ListScenarios$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [GetScenarioStore, GetScenario$result, GetScenario$input], [GetSceneStore, GetScene$result, GetScene$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input], [GetComposerStore, GetComposer$result, GetComposer$input]];
};