...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListScenariosStore, ListScenarios$result, ListScenarios$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [GetSceneStore, GetScene$result, GetScene$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetScenarioStore, GetScenario$result, GetScenario$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [GetComposerStore, GetComposer$result, GetComposer$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input]];
};