...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetSceneStore, GetScene$result, GetScene$input], [GetScenarioStore, GetScenario$result, GetScenario$input], [ListScenariosStore, ListScenarios$result, ListScenarios$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetComposerStore, GetComposer$result, GetComposer$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input]];
};