...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListScenesStore, ListScenes$result, ListScenes$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetSceneStore, GetScene$result, GetScene$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input], [GetComposerStore, GetComposer$result, GetComposer$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input]];
};