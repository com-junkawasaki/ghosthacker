...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListScenesStore, ListScenes$result, ListScenes$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetSceneStore, GetScene$result, GetScene$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input], [GetComposerStore, GetComposer$result, GetComposer$input]];
};