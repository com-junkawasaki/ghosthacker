...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [GetSceneStore, GetScene$result, GetScene$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetComposerStore, GetComposer$result, GetComposer$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input]];
};