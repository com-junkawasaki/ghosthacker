...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListScenariosStore, ListScenarios$result, ListScenarios$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListComposersStore, ListComposers$result, ListComposers$input], [GetScenarioStore, GetScenario$result, GetScenario$input], [GetSceneStore, GetScene$result, GetScene$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetComposerStore, GetComposer$result, GetComposer$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input]];
};