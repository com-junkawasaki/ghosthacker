...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [GetSceneStore, GetScene$result, GetScene$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input]];
};