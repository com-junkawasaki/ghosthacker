...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListComposersStore, ListComposers$result, ListComposers$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input], [GetSceneStore, GetScene$result, GetScene$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetComposerStore, GetComposer$result, GetComposer$input]];
};