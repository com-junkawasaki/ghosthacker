...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListComposersStore, ListComposers$result, ListComposers$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [GetComposerStore, GetComposer$result, GetComposer$input], [GetSceneStore, GetScene$result, GetScene$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input]];
};