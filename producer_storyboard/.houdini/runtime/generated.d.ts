...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListScenesStore, ListScenes$result, ListScenes$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [GetSceneStore, GetScene$result, GetScene$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input], [ListProjectsStore, ListProjects$result, ListProjects$input]];
};