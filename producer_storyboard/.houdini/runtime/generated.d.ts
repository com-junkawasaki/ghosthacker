...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[ListSunoMusicStore, ListSunoMusic$result, ListSunoMusic$input], [ListScenesStore, ListScenes$result, ListScenes$input], [ListProjectsStore, ListProjects$result, ListProjects$input], [ListStoryboardsStore, ListStoryboards$result, ListStoryboards$input], [ListHumeVoicesStore, ListHumeVoices$result, ListHumeVoices$input], [ListCharactersStore, ListCharacters$result, ListCharacters$input], [ListCharacterAssetsStore, ListCharacterAssets$result, ListCharacterAssets$input], [ListAudioTracksStore, ListAudioTracks$result, ListAudioTracks$input], [ListAudioClipsStore, ListAudioClips$result, ListAudioClips$input], [ListGeneratedVideosStore, ListGeneratedVideos$result, ListGeneratedVideos$input], [ListComposersStore, ListComposers$result, ListComposers$input], [GetSceneStore, GetScene$result, GetScene$input], [GetComposerStore, GetComposer$result, GetComposer$input], [GetCharacterAssetDataStore, GetCharacterAssetData$result, GetCharacterAssetData$input], [ListDialoguesStore, ListDialogues$result, ListDialogues$input], [GetGeneratedImagesStore, GetGeneratedImages$result, GetGeneratedImages$input]];
};