...
CREATE INDEX idx_storyboard_projects_created_at ON storyboard_projects(created_at DESC);
...
CREATE INDEX idx_generated_videos_storyboard_id ON generated_videos(storyboard_id);
CREATE INDEX idx_generated_videos_status ON generated_videos(status);
CREATE INDEX idx_generated_videos_openai_job_id ON generated_videos(openai_job_id);
